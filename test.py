...
response = requests.get('https://www.fragrantica.com/perfume/Acqua-di-Parma/Colonia-Artist-Edition-by-Clym-Evernden-52150.html', headers = {'User-agent': 'your bot 0.1'})
html = response.text
